...
// parseSectionsModelV1 parses a CATF document into the section model while
// enforcing structural constraints, but it does NOT enforce canonical key order.
//
// This exists to support model-first canonicalization/normalization workflows.
func parseSectionsModelV1(data []byte) (*parsedSections, error) {
