...
- CROF byte/structure malformations (BOM/invalid UTF-8, missing pre/postamble, unexpected content, missing/out-of-order sections, unsorted META, missing required META keys, missing section terminator blank line): `src/crof/canonicalize_test.go`.
