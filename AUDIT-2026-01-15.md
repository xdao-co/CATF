...
- CROF structural malformations (missing/out-of-order sections, unsorted META, missing required META keys, missing section terminator blank line): `src/crof/canonicalize_test.go`.
