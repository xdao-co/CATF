...
XDAO_CASGRPCD_BIN="$REPO_ROOT/bin/xdao-casgrpcd-ipfs"
...
if ! command -v ipfs >/dev/null 2>&1; then
  ...
  echo "Install Kubo, then rerun: make walkthrough-grpc-ipfs" >&2
  exit 1
fi

WORK_DIR="$(mktemp -d /tmp/xdao-walk-grpc-ipfs.XXXXXX)"
